...
public class MoverAuthoring : MonoBehaviour, IConvertGameObjectToEntity
{
    ...
    public void Convert(Entity entity, EntityManager dstManager, GameObjectConversionSystem conversionSystem)
    {
        ...
        //
        // For example,
        dstManager.AddComponentData(entity, new Mover { speed = speed, distanceOnLane = distanceOnLane });
